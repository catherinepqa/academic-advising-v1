                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.msg == 'success') {
                                ...
                                swal({
                                    title: "Success!",
                                    text: "Successfully created new Student Account.",
                                    type: "success",
                                    confirmButtonColor:"#f2993e",
                                }, function () {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                if (data.message == 'success') {
                                    ...
                                    swal({
                                        title: "Success!",
                                        text: "Successfully updated a student account.",
                                        type: "success",
                                        confirmButtonColor:"#f2993e",
                                    }, function () {
...
function edit(id) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('.update_student_number').val(data.student_number);
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.message == 'success') {
                        ...
                        swal({
                            title: "Success!",
                            text: "Successfully deleted a student account.",
                            type: "success",
                            confirmButtonColor:"#f2993e",
                        }, function () {
