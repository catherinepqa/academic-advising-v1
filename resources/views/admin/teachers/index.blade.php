            ...
            <div class="modal-body p-4">
                <form id="addForm">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="field-4" class="control-label">Employee Number</label>
                                <input type="text" class="form-control" id="field-4" name="employee_number">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                ...
                <form id="updateForm">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="field-4" class="control-label">Employee Number</label>
                                <input type="text" class="form-control update_employee_number" id="field-4" name="employee_number">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
@section('js')
    ...
    <script>
        var add_url     = "{{ route('teacherAdd') }}";
        var data_url    = "{{ route('teacherDataList') }}";
        var edit_url    = "{{ route('teacherDetails') }}";
        var update_url  = "{{ route('teacherUpdateData') }}";
        var del_url     = "{{ route('teacherDeleteData') }}";
    </script>

    <script src="{{ URL::asset('assets/js/pages/teachers/index.js') }}"></script>
@endsection