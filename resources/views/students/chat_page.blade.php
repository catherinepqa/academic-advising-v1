    ...
    <div class="card-body py-2 px-3 border-bottom border-light">
        <div class="media py-1">
            @if ($receiver->avatar != null)
                <img src="{{ URL::asset('assets/images/user_avatars/') }}/{{ $receiver->profile_id }}/{{ $receiver->avatar }}" class="mr-2 rounded-circle" height="36">
            @else
            ...
            <div class="media-body">
                <h5 class="mt-0 mb-0 font-15">
                    <a href="contacts-profile.html" class="text-reset">{{ $receiver->first_name.' '.$receiver->last_name }}</a>
                </h5>
            ...
            @foreach ($replies as $reply)
                ...
                @else
                    <li class="clearfix">
                        <div class="chat-avatar">
                            @if ($receiver->avatar != null)
                                <img src="{{ URL::asset('assets/images/user_avatars/') }}/{{ $receiver->profile_id }}/{{ $receiver->avatar }}" class="rounded" height="40">
                            @else
                    ...
                    <form class="needs-validation" novalidate="" name="chat-form" id="chat-form">
                        <div class="row">
                            <div class="col mb-2 mb-sm-0">
                                ...
                                <input type="hidden" class="parent_id" name="parent_id" value="{{ $parent_id }}">
                                <input type="hidden" name="receiver_id" value="{{ $receiver->profile_id }}">
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.msg == 'success') {
                    ...
                    $('.chat_active_'+parent_id).addClass('bg-light');
                    $('.chat-msg').val('');  
