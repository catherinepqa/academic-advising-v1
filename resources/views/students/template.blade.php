            ...
            <ul class="list-unstyled topnav-menu float-right mb-0">
                ...
                <li class="dropdown notification-list topbar-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-lg">
                        ...
                        <!-- All-->
                        <a href="{{ route('studentNotifications') }}" class="dropdown-item text-center text-primary notify-item notify-all">
                            View all
                            <i class="fe-arrow-right"></i>
                        </a>
                ...
                <li class="dropdown notification-list topbar-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                        ...
                        <a href="{{ route('studentCalendar') }}" class="dropdown-item notify-item 
                        {{ (request()->is('student/calendar')) ? 'active' : '' }}">
            ...
            success: function(data) {
                if (data != '') {
                    ...
                    $.each( data, function( key, value ) {
                        ...
                        $('.noti').append('<div class="noti-scroll" data-simplebar><a href="{{ route('studentNotifications') }}" onclick="markAsRead('+value.msg_id+')" class="dropdown-item notify-item '+active+'"> ' +
            ...
            success: function(data) {
                if (data != '') {
                    ...
                    $.each( data, function( key, value ) {
                        ...
                        if (value.receiver_avatar != '') {
                            img = '{{ URL::asset('assets/images/user_avatars/') }}/'+value.receiver_id+'/'+value.receiver_avatar;
                        } else {
                            img = '../assets/images/user.png';
                        }

                        $('.msg').append('<div class="noti-scroll msg-scroll" data-simplebar><a href="{{ route('studentChat') }}" onclick="markAsRead('+value.parent_id+')" class="dropdown-item notify-item '+active+'"> ' +
                                '<div class="notify-icon"> ' +
                                '<img src="'+img+'" class="img-fluid rounded-circle" /> ' +
                                '</div> <p class="notify-details">'+value.receiver_name+'</p> ' +
                                '<p class="text-muted mb-0 user-msg"> ' +
